...
生产镜像应使用不可变的 Git 提交 SHA 或发布标签，不建议使用浮动的 `latest` 作为回滚依据。每个公开版本必须通过 CI、容器构建、密钥扫描和 CodeQL，并附带迁移与回滚说明。发布流程见 [公开发布清单](./docs/PUBLIC_RELEASE_CHECKLIST.md)，当前版本说明见 [v0.2.0](./docs/releases/v0.2.0.md)。
